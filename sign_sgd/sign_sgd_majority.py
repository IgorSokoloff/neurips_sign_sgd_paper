...
parser.add_argument('--step_type', action='store', dest='step_type', type=str, default='',
                    help='variable or fixed stepsize ')

parser.add_argument('--loss_func', action='store', dest='loss_func', type=str, default='',
                    help='loss function ')
...
experiment = '{0}_{1}_{2}_{3}_{4}_{5}'.format(experiment_name, loss_func, step_type, n_workers, gamma_0, batch)


#save data of the experiment to disk
info_str = [experiment_name, project_path, logs_path, dataset, loss_func]

np.save(logs_path + 'info_number', np.array([step_type, n_workers, gamma_0, batch]))
